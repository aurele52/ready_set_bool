...
let conjunctive_normal_form (str: string): string = btree_to_RPN_app (distrib (Utils.Btree_construct.btree_construct (Common.Negation_normal_form.negation_normal_form str)))
